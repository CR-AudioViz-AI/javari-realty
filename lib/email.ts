...
// Customer invite - accepts both email and customerEmail for flexibility
export async function sendCustomerInviteEmail(data: {
  ...
  const { customerName, agentName, tempPassword, loginUrl } = data;
  return sendEmail({
    to: recipientEmail,
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: #f9fafb;">
          ...
          <div style="background: white; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px; margin: 20px 0;">
            ...
            <p style="margin: 0; font-size: 14px;"><strong>Email:</strong> ${recipientEmail}</p>
...
// Alias
export const sendCustomerInvite = sendCustomerInviteEmail;
