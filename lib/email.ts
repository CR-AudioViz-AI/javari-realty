...
export async function sendCustomerInvite(data: {
  ...
  try {
    const result = await resend.emails.send({
      from: `CR Realtor Platform <${FROM_EMAIL}>`,
      to: email,
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 30px; background: #f9fafb;">
            ...
            <p style="font-size: 16px; color: #374151;">
              ${agentName} has invited you to their exclusive client portal where you can:
            </p>
            <ul style="color: #374151; font-size: 14px;">
              <li>Search and save properties</li>
              <li>Schedule showings online</li>
              <li>Track your home search progress</li>
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${loginUrl}" style="display: inline-block; background: #2563eb; color: white; padding: 14px 30px; border-radius: 8px; text-decoration: none; font-weight: 600;">
                Access Your Portal
              </a>
            </div>
...
export async function sendShowingConfirmation(data: {
  ...
  if (!process.env.RESEND_API_KEY) return { success: true, demo: true };
