...
// Complete Remote Workers Module Landing Page
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                <div className="text-4xl font-bold mb-2">{properties?.length || 47}</div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Properties tagged for remote-workers, near bases, or with veteran sellers
              </p>
            </div>
            ...
            <div className="text-center mt-12">
              <Link
                href="/search?social_impact=remote-workers"
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of remote-workers who've found their dream homes with CR Realtor Platform
          </p>
